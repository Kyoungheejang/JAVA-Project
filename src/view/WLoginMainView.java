...
public class WLoginMainView extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					WLoginMainView frame = new WLoginMainView();
