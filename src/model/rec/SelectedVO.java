...
public class SelectedVO {
   ...
   public SelectedVO() {
	...
	// 유승민
   public SelectedVO(int supCode, int workerCode, int reqCode, String supState, String supSdate) {
      // TODO Auto-generated constructor stub
   ...
   public SelectedVO(int workerCode, int workerCareerCode, int certiCode,
